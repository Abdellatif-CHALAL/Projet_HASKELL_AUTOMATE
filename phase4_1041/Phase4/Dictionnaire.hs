...
data Dictionnaire cle val  = Noeud [cle] val (Dictionnaire cle val) (Dictionnaire cle val) | Vide deriving(Eq)
-- Creer un arbre vide
...
{--
toListCleVal :: Dictionnaire cle val -> [((cle,cle),val)]
toListCleVal Vide = []
...
toListCleVal :: (Dictionnaire cle val) -> [((cle,cle),val)]
toListCleVal Vide = []
toListCleVal (Noeud l v g d ) = (toListCleVal g) ++ [((head l,last l),v)] ++ (toListCleVal d)
